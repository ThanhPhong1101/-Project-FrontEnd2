    ...
    execute: function () {
      ...
      _export("EventSystem", EventSystem = (_dec = ccclass('EventSystem'), _dec2 = property({
        ...
        GamePadOnKeyDown(event) {
          ...
          var leftAction = event.gamepad.dpad.left.getValue() == 1;
          var rightAction = event.gamepad.dpad.right.getValue() == 1;
          var upAction = event.gamepad.dpad.up.getValue() == 1;
          var downAction = event.gamepad.dpad.down.getValue() == 1;
