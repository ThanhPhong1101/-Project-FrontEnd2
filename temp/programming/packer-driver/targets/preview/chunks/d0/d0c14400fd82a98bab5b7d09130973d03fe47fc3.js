      ...
      = (_dec = ccclass('AndroidNative'), _dec(_class = class AndroidNative // Khai báo lớp AndroidNative
      {
        static showAlert(message) // Phương thức tĩnh showAlert
        {
          if (sys.os === sys.OS.ANDROID) // Kiểm tra hệ điều hành
            {
              var className = "com/cocos/game/AppActivity"; // Tên của lớp Java

              var methodName = "showAlertDialog"; // Tên của phương thức Java

              var methodSignature = "(Ljava/lang/String;Ljava/lang/String;)V"; // Chữ ký của phương thức Java
          ...
          if (sys.os === sys.OS.ANDROID) // Kiểm tra hệ điều hành
            {
              ...
              var methodName = "showToast"; // Tên của phương thức Java

              var methodSignature = "(Ljava/lang/String;I)V"; // Chữ ký của phương thức Java
